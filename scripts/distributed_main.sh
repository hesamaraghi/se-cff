...
save_root=/home/nfs/maraghi/NSEK/Model_zoo/Depth_estimation/se-cff/saved_results_2_15_15M_256_beta_1
save_term=10
num_workers=8
NUM_PROC=2  # Number of processes for distributed training
checkpoint_path=${save_root}/latest.pth  # Default checkpoint path
...
CUDA_VISIBLE_DEVICES=${cuda_idx} python3 -m torch.distributed.launch \
    --nproc_per_node=$NUM_PROC --master_port=$RANDOM src/distributed_main.py \
